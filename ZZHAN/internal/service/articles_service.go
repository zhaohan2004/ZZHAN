...
func (s *articlesService) GetBySlug(ctx context.Context, slug string, clientIP string, userID int64) (*dto.ArticleDetail, error) {
	return s.articlesRepo.GetBySlug(ctx, slug, clientIP, userID)
}
