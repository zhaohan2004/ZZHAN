...
type Comment struct {
	...
	ParentID   *int64 `gorm:"type:bigint unsigned;index;comment:父评论ID(楼中楼回复)" json:"parent_id"`
	UserID     *int64 `gorm:"type:bigint unsigned;comment:登录用户ID；匿名为 NULL" json:"user_id"`
