...
// User 前台用户表（GitHub OAuth 登录，无密码）
type User struct {
	BaseEntity
	Provider    string     `gorm:"type:varchar(20);not null;uniqueIndex:uk_users_provider_openid,priority:1;comment:登录方式：github" json:"provider"`
