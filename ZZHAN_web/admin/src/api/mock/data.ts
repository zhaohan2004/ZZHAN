...
export const MOCK_CATEGORIES = [
  { id: 1, name: 'Go', slug: 'go', icon: 'code-2', desc: 'Go 语言基础、并发模型与工程实践', color: '#3b82f6', count: 2, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 2, name: 'MySQL', slug: 'mysql', icon: 'database', desc: 'MySQL 原理、索引优化与实战调优', color: '#38bdf8', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 3, name: 'Redis', slug: 'redis', icon: 'zap', desc: 'Redis 核心数据结构与缓存设计', color: '#fb7185', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 4, name: 'Linux', slug: 'linux', icon: 'terminal', desc: 'Linux 命令、系统管理与排查实战', color: '#a3e635', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 5, name: 'Docker', slug: 'docker', icon: 'container', desc: '容器化部署与镜像构建实践', color: '#60a5fa', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 6, name: 'Git', slug: 'git', icon: 'git-branch', desc: 'Git 版本控制与团队协作规范', color: '#fb923c', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 7, name: 'Gin', slug: 'gin', icon: 'route', desc: 'Gin 框架与 Web 服务开发实战', color: '#34d399', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 8, name: 'WebSocket', slug: 'websocket', icon: 'radio', desc: '实时通信协议与长连接实践', color: '#93c5fd', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 9, name: 'SSE', slug: 'sse', icon: 'activity', desc: '服务端推送与流式响应实现', color: '#fbbf24', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 10, name: '数据结构与算法', slug: 'algorithm', icon: 'network', desc: '数据结构、算法设计与刷题笔记', color: '#f472b6', count: 1, created_at: '2024-01-01', updated_at: '2026-08-18' },
  { id: 11, name: '计算机基础', slug: 'cs', icon: 'cpu', desc: '操作系统、网络与计算机组成原理', color: '#94a3b8', count: 2, created_at: '2024-01-01', updated_at: '2026-08-18' },
]

export const MOCK_TAGS = [
  { id: 1, name: 'Go', count: 3, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 2, name: '并发', count: 4, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 3, name: 'Gin', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 4, name: 'GORM', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 5, name: 'MySQL索引', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 6, name: 'JWT', count: 2, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 7, name: 'JWT认证', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 8, name: 'Redis', count: 2, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 9, name: '缓存', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 10, name: 'WebSocket', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 11, name: 'SSE', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 12, name: 'Docker', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 13, name: 'Linux', count: 2, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 14, name: 'Git', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 15, name: '数据结构', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 16, name: '算法', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 17, name: '分布式', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 18, name: '性能优化', count: 3, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 19, name: '面试', count: 2, created_at: '2024-01-05', updated_at: '2024-01-05' },
  { id: 20, name: '源码阅读', count: 1, created_at: '2024-01-05', updated_at: '2024-01-05' },
]
